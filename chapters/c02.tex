...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=8cm, height = 5.5cm]{images/c02/EM Waves/Wave_u_parameter.PNG}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[scale=0.45]{images/c02/EM Waves/Light_EM_Wave.png}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=11cm]{images/c02/EM Waves/EM_Spectrum.jpg}}
...
%\begin{figure}[htbp]
%    \centering
%    \fbox{\includegraphics[width=12cm]{images/c02/Polarization/Linearly_Polarized_Light.png}}
...
%\begin{figure}[htbp]
%    \centering
%    \fbox{\includegraphics[width=12cm]{images/c02/Polarization/Types_of_Polarization.jpg}}
...
%\begin{figure}[htbp]
%    \centering
%    \fbox{\includegraphics[width=12cm]{images/c02/Polarization/Unpolarized_Light.png}}
...
%\begin{figure}[htbp]
%    \centering
%    \fbox{\includegraphics{images/c02/OAM/SAM.png}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=10cm]{images/c02/OAM/SAM_OAM.png}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=9.5cm]{images/c02/OAM/OAM_topological_charge.PNG}}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \fbox{\includegraphics[width=\textwidth]{images/c02/OAM/HG_to_LG_resized.png}}
        \caption{First method: conversion from HG to LG modes \cite{Yao-Padgett:2011}.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \fbox{\includegraphics[width=\textwidth]{images/c02/OAM/OAM_Plate.PNG}}
        \caption{Second method: Using a spiral phase plate \cite{Yao-Padgett:2011}.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \fbox{\includegraphics[width=\textwidth]{images/c02/OAM/Gaussian-Fork-OAM.png}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=8.5cm]{images/c02/OAM/GaussianBeamWaist.png}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=10cm]{images/c02/Propagation/Fresnel-Fraunhoffer_Diffraction.jpg}}
