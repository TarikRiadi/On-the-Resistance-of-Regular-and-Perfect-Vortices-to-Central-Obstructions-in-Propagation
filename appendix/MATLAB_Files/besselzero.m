...
switch kind
    case 1
        ...
        % n=0:10000.
        coefficients1j = [0.411557013144507;0.999986723293410;
        ...
        if k >= 2
            ...
            % n=0:10000.
            coefficients2j = [1.93395115137444;1.00007656297072;
        ...
        if k >= 3
            ...
            % n=0:10000.
            coefficients3j = [5.40770803992613;1.00093850589418;
    ...
    case 2
        % coefficients and exponent are from least squares fitting the k=1,
        % n=0:10000.
        coefficients1y = [0.0795046982450635;0.999998378297752;
        ...
        if k >= 2
            % coefficients and exponent are from least squares fitting the k=2,
            % n=0:10000.
            coefficients2y = [1.04502538172394;1.00002054874161;
        ...
        if k >= 3
            % coefficients and exponent are from least squares fitting the k=3,
            % n=0:10000.
            coefficients3y = [3.72777931751914;1.00035294977757;
